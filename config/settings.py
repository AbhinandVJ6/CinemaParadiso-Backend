...
X_FRAME_OPTIONS = '*'
CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1:8000','https://backend-cinema-pardiso.oloye747.repl.co','https://backend-cinema-pardiso.oloye747.repl.co/admin/login/?next=/admin/']
